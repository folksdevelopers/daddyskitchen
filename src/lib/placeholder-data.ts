...
export type Product = {
  ...
  slug: string;
  description: string;
  category: 'Spices' | 'Masala' | 'Flours' | 'Rices' | 'Blends' | 'Salts' | 'Herbs' | 'Lentils';
  imageUrl: string;
  price: number;
  quantity: number;
  weights: string[];
