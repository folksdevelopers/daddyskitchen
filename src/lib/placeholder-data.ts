...
export const allProducts: Product[] = [
  ...
  { id: '28', name: 'Shawarma Masala', slug: 'shawarma-masala', minDescription: 'Mediterranean street food blend with sumac and garlic creating juicy smoky-tangy meat preparations.', description: 'Mediterranean street food authenticity captured in aromatic powder featuring sumac, garlic, and Middle Eastern spices. Creates juicy, flavorful meat preparations with distinctive smoky-tangy profiles. Brings authentic Lebanese and Syrian shawarma experience home, perfect for marinating meats and creating restaurant-quality Middle Eastern cuisine.', category: 'Masala', imageUrl: '/shawarma-masala.jpg', weights: ['25Kg', '15Kg', '5Kg'], price: 0, quantity: 0, features: ['High Quality', '100% Organic', 'No Chemicals'] },
